    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('expires', models.DateTimeField(default=datetime.datetime(2024, 4, 23, 11, 36, 44, 502688, tzinfo=datetime.timezone.utc))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_friend_mappings', to=settings.AUTH_USER_MODEL)),
            ],
            options={
